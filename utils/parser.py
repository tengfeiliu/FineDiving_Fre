...
def get_args():
    ...
    parser.add_argument('--archs', type = str, default='TSA',choices=['TSA'], help = 'our approach')
    parser.add_argument('--benchmark', type = str, default='FineDiving',  choices=['FineDiving'], help = 'dataset')
